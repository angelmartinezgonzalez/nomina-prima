...
**Para Windows** **Utiliza python 3.14.0**
...
python-stdnum==2.2
pycurl==7.46.0
psycopg-binary==3.3.4pg-binary==3.3.4
...
## Ejecutar localmente para desarrollo depuracion
